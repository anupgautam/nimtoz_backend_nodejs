...
const createProduct = async (req, res) => {
    ...
    try {
        ...
        const parsedData = {
            ...
            entertainment:
                typeof req.body.entertainment === "string" ? JSON.parse(req.body.entertainment) : req.body.entertainment,
            ...
            cateringtent:
                typeof req.body.cateringtent === "string" ? JSON.parse(req.body.cateringtent) : req.body.cateringtent,
        ...
        const product = await prisma.product.create({
            data: {
                ...
                category_id: Number.parseInt(parsedData.category, 10),
                districtId: Number.parseInt(parsedData.location, 10),
                businessId: Number.parseInt(parsedData.business, 10),
